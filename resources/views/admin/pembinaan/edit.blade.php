...
@section('title', 'Edit Data Pembinaan')
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control @error('kode_pembinaan') is-invalid @enderror "  name="kode_pembinaan" @if (old('kode_pembinaan')) value="{{ old('kode_pembinaan') }}" @else value="{{ $pembinaan->kode_pembinaan }}" @endif>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control @error('nama_pembinaan') is-invalid @enderror "  name="nama_pembinaan" @if (old('nama_pembinaan')) value="{{ old('nama_pembinaan') }}" @else value="{{ $pembinaan->nama_pembinaan }}" @endif>
